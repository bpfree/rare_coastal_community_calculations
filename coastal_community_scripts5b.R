...
## output directory
table_dir <- "data//r_dump"
output_dir <- "data//r_dump"

### 2. Load cleaned coastal data
bra_coastal_communities <- st_read(coastal_dir, "bra_coastal_communities_r")
bra_para_coastal_communities <- st_read(coastal_dir, "bra_para_coastal_communities_r")
fsm_coastal_communities <- st_read(coastal_dir, "fsm_coastal_communities_r")
gtm_coastal_communities <- st_read(coastal_dir, "gtm_coastal_communities_r")
hnd_coastal_communities <- st_read(coastal_dir, "hnd_coastal_communities_r")
idn_coastal_communities <- st_read(coastal_dir, "idn_coastal_communities_r")
moz_coastal_communities <- st_read(coastal_dir, "moz_coastal_communities_r")
phl_coastal_communities <- st_read(coastal_dir, "phl_coastal_communities_r")
plw_coastal_communities <- st_read(coastal_dir, "plw_coastal_communities_r")
